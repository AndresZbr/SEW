...
namespace XmlToSvg
{
    class MainClass
    {
        ...
        // Tamaño y espaciado de los nodos
        private const int elementWidth = 300;      // Ancho de cada nodo (antes 200)
        private const int elementHeight = 50;      // Alto de cada nodo (antes 40)
        private const int elementSpacingX = 350;   // Separación horizontal entre nodos (antes 220)
        private const int elementSpacingY = 70;    // Separación vertical entre niveles (antes 50)
        ...
        private static void WriteSVGHeader(XmlWriter xmlWriter, int height)
        {
            ...
            xmlWriter.WriteAttributeString("width", "1600");
